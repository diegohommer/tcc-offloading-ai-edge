#!/usr/bin/env python3
"""Hourly LLM request counts from public traces: the OLT's load for sim_piggyback.py --load-trace.
...
Usage:
    python src/scripts/prepare_load_traces.py            # BurstGPT only
    python src/scripts/prepare_load_traces.py --azure    # + Azure 2024 conversation (streams 1.1 GB)
